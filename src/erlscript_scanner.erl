-file("c:/Program Files/erl6.3/lib/parsetools-2.0.12/include/leexinc.hrl", 0).
...
-module(erlscript_scanner).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/erlscript_scanner.xrl", 30).
...
-file("c:/Program Files/erl6.3/lib/parsetools-2.0.12/include/leexinc.hrl", 14).
...
-file("src/erlscript_scanner.erl", 283).
yystate() -> 42.
...
yystate(46, [10|Ics], Line, Tlen, _, _) ->
    yystate(46, Ics, Line+1, Tlen+1, 7, Tlen);
...
yystate(42, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(33, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [119|Ics], Line, Tlen, Action, Alen) ->
...
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 42 ->
    yystate(33, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(40, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 60 ->
    yystate(33, Ics, Line, Tlen+1, Action, Alen);
...
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 113 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 116, C =< 118 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(42, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(32, [60|Ics], Line, Tlen, _, _) ->
    yystate(38, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 46 ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 48 ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/erlscript_scanner.xrl", 12).
yyaction_0(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_1/2}).
-file("src/erlscript_scanner.xrl", 13).
yyaction_1(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_2/2}).
-file("src/erlscript_scanner.xrl", 14).
yyaction_2(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_3/2}).
-file("src/erlscript_scanner.xrl", 15).
yyaction_3(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("src/erlscript_scanner.xrl", 16).
yyaction_4(TokenChars, TokenLine) ->
     { token, { var, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/3}).
-file("src/erlscript_scanner.xrl", 17).
yyaction_5(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { string, TokenLine, S } } .

-compile({inline,yyaction_6/3}).
-file("src/erlscript_scanner.xrl", 19).
yyaction_6(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { string, TokenLine, S } } .

-compile({inline,yyaction_7/0}).
-file("src/erlscript_scanner.xrl", 21).
yyaction_7() ->
     skip_token .

-compile({inline,yyaction_8/0}).
-file("src/erlscript_scanner.xrl", 22).
yyaction_8() ->
     skip_token .

-compile({inline,yyaction_9/0}).
-file("src/erlscript_scanner.xrl", 23).
yyaction_9() ->
     skip_token .

-compile({inline,yyaction_10/2}).
-file("src/erlscript_scanner.xrl", 24).
yyaction_10(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_11/2}).
-file("src/erlscript_scanner.xrl", 25).
yyaction_11(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_12/2}).
-file("src/erlscript_scanner.xrl", 26).
yyaction_12(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, hex_to_int (TokenChars) } } .

-file("c:/Program Files/erl6.3/lib/parsetools-2.0.12/include/leexinc.hrl", 282).
